# ported from https://github.com/NixOS/nixpkgs/blob/master/nixos/modules/services/networking/syncthing.nix
{ config, lib, pkgs, ... }:
  ...
  options = {
    services.syncthing = {
      ...
      in mkOption {
        ...
        '';
        default = "/Users/phlmn/Library/Application Support/Syncthing";
  ...
  config = mkIf cfg.enable {
    ...
    launchd.user.agents.syncthing-init = {
      serviceConfig = {
        ...
        ThrottleInterval = 3600; # 60 minutes

        KeepAlive = {
          OtherJobEnabled = {
            "org.nixos.syncthing" = true;
          };
        };
      };
    };
